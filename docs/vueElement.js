...
(function () {
  if (typeof document !== 'undefined') {
    var head = document.head || document.getElementsByTagName('head')[0],
        style = document.createElement('style'),
        css = " h1[data-v-00eaf099], h2[data-v-00eaf099] { font-weight: normal; } ul[data-v-00eaf099] { list-style-type: none; padding: 0; } li[data-v-00eaf099] { display: inline-block; margin: 0 10px; } a[data-v-00eaf099] { color: #668bdb; } ";style.type = 'text/css';if (style.styleSheet) {
      style.styleSheet.cssText = css;
    } else {
      style.appendChild(document.createTextNode(css));
    }head.appendChild(style);
